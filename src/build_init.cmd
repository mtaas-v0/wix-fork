...
msbuild -Restore internal\SetBuildNumber\SomeVerInit.verproj -nologo -p:SomeVerMinimumMajorMinor=8.0  -bl:%_L%\somever_init.binlog

echo ":: LIST TARGETS"
:: msbuild internal\SetBuildNumber\SomeVerInit.verproj -targets

:: echo ":: BEFORE msbuild SomeVerInit.verproj"
:: msbuild internal\SetBuildNumber\SomeVerInit.verproj -target:SomeVerApplyVersionTemplates
